...
9. [Notes & Disclosures on the Use of AI](#notes--disclosures-on-the-use-of-ai)
10. [Theoretical Foundations & References](#theoretical-foundations--references)
11. [Project Structure](#project-structure)
12. [EU AI Act Compliance Notes](#eu-ai-act-compliance-notes)
---
...
This maps directly to the bias, risk, and opacity framework introduced by Quaresmini & Primiero (2024).
...
The matching and fairness analysis pipeline is implemented in **pure TypeScript** with no external AI/ML libraries, and this is a deliberate design choice, not a limitation because I wanted to focus on the logics leanred during our lectures behind the project requested by our Professor. Of course on the future versions of the app will be implemented proper XAI (Explainable AI) Algorithms.
...
This is precisely the argument that Quaresmini & Primiero (2024) make: for high-stakes domains like housing access, transparency and formal correctness matter more than raw predictive power.
...
You can simply click on this link https://coinqui-logics-for-ai.vercel.app/ since I deployed and published this version of the app.
---
...
Violations are counted. A high violation count indicates that the correction distance penalises similar profiles differently, a form of individual unfairness that the bias and fairness framework of Quaresmini & Primiero (2024) explicitly targets.
...
## Notes & Disclosures on the Use of AI
...
Throughout the development process, a **human-in-the-loop** approach was maintained: all outputs generated with AI assistance were reviewed, validated, and intentionally accepted or revised by the author. The final design decisions, framing of the argument, and academic positioning of the project remain the author's own.
...
| Reference | Used For |
|---|---|
| **Quaresmini & Primiero (2024)** - *Information-Theoretic Fairness* | Bias, risk, and opacity framework; Correction Distance C (Def 99); Informational Confidence ξ (Def 95); Blind Similarity BSim (Def 103-104) |
...
│   ├── logic/
│   │   ├── LogicEngine.ts         # Core proof-theoretic matching engine
